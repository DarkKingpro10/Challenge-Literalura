package com.je.literalura.principal;
...
public class Principal {
	...
	public void obtenerDatosLibros() {
        System.out.println("\n\n");
	...
	public void mostrarLibrosEnBaseDatos() {
    ...
    public void mostrarAutoresVivosEnAño() {
    ...
    public void buscarLibrosLenguaje() {
    ...
    public String cortarTitulo(String titulo){
